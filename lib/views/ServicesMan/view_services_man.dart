...
import 'add_service_man.dart';

class ViewServicesMan extends StatelessWidget {
  const ViewServicesMan({super.key});
                            ...
                            children: [
                              Align(
                                ...
                                child: PaddingCustom(
                                  ...
                                  child: TextCustom(
                                      height: 1.5,
                                      theText: "واجهة الفنيين الرئيسية",
                                      fontSizeWidth: 8.sp,
                              ...
                              Align(
                                ...
                                child: PaddingCustom(
                                  ...
                                  child: TextCustom(
                                      height: 1.5,
                                      theText:
                                          "معلومات واحصائيات شاملة عن الفنيين  المتوفرين في قاعدة البيانات",
                                      fontSizeWidth: 4.sp,
                                      fontWeight: FontWeight.bold,
                                      fontFamily: AppTextStyles.Almarai,
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                                  ...
                                                                                  Container(
                                                                                    alignment: Alignment.center,
                                                                                    width: 35.w,
                                                                                    child: TextCustom(theText: snapshot.data['data'][i]['password'].toString(), fontSizeWidth: 5.2.sp, fontFamily: AppTextStyles.Almarai, fontColor: AppColors.balckColorTypeThree, height: 1.5.h),
                                                                                  ),
                                                                                  SizedBox(
                                                                                    width: 5.w,
                                                                                  ),
                              ...
                              PaddingCustom(
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      if (homeController.typeOfAdmin.value !=
                                          2) {
                                        homeController
                                            .aboutAccessTheAdminMessage
                                            .value = true;
                                      } else {
                                        homeController.isChooseEditServiceMan =
                                            0;
                                        Get.to(AddServiceManScreenDeskTop());
                                      }
                                    },
                                    child: Container(
                                        alignment: Alignment.center,
                              ...
                              PaddingCustom(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                        onTap: () {
                                          controller.isChooseEditServiceMan = 1;
                                          Get.to(AddServiceManScreenDeskTop());
                                        },
                                        child: Container(
                                            alignment: Alignment.center,
