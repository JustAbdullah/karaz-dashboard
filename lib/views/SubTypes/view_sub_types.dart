...
import 'add_sub_type.dart';

class ViewSubTypes extends StatelessWidget {
  const ViewSubTypes({super.key});
                            ...
                            Align(
                              ...
                              child: PaddingCustom(
                                ...
                                child: TextCustom(
                                    height: 1.5,
                                    theText:
                                        "معلومات واحصائيات شاملة عن الخدمات الفرعية المتوفرة في قاعدة البيانات",
                                    fontSizeWidth: 4.sp,
                                    fontWeight: FontWeight.bold,
                                    fontFamily: AppTextStyles.Almarai,
                                                ...
                                                builder: (controller) =>
                                                    FutureBuilder(
                                                        future: controller
                                                                    ...
                                                                    .value ==
                                                                true
                                                            ? controller.searchinSubName(
                                                                controller
                                                                    .nameSearching
                                                                    .toString())
                                                            : homeController
                                                                .getDataSubTypesDatabase(),
                                                                                ...
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                                    Container(
                                                                                      ...
                                                                                      width: 40.w,
                                                                                      child: TextCustom(theText: snapshot.data['data'][i]['sub_type_id'].toString(), fontSizeWidth: 5.2.sp, fontFamily: AppTextStyles.Almarai, fontColor: AppColors.balckColorTypeThree, height: 1.5.h),
                                                                                    ),
                                                                                    SizedBox(
                                                                                      width: 5.w,
                                                                                    ),
                                                                                    ...
                                                                                    Container(
                                                                                      alignment: Alignment.center,
                                                                                      width: 40.w,
                                                                                      child: TextCustom(theText: snapshot.data['data'][i]['sub_type_name_en'].toString(), fontSizeWidth: 5.2.sp, fontFamily: AppTextStyles.Almarai, fontColor: AppColors.balckColorTypeThree, height: 1.5.h),
                                                                                    ),
                                                                                    SizedBox(
                                                                                      width: 5.w,
                                                                                    ),
                              ...
                              PaddingCustom(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      onTap: () {
                                        controller.deleteSubType(controller
                                            .ofIdSubTypeDeleteOrEdit
                                            .toString());
                                      },
                                      child: Container(
                                          alignment: Alignment.center,
                                    ...
                                    InkWell(
                                        onTap: () {
                                          controller.isChooseEditSubType = 1;
                                          Get.to(AddSubTypeScreenDeskTop());
                                        },
                                        child: Container(
                                            alignment: Alignment.center,
