                          ...
                          children: [
                            Align(
                              ...
                              child: PaddingCustom(
                                ...
                                child: TextCustom(
                                    height: 1.5,
                                    theText: "واجهة الخدمات الرئيسية",
                                    fontSizeWidth: 8.sp,
                            ...
                            Align(
                              ...
                              child: PaddingCustom(
                                ...
                                child: TextCustom(
                                    height: 1.5,
                                    theText:
                                        "معلومات واحصائيات شاملة عن الخدمات الرئيسية المتوفرة في قاعدة البيانات",
                                    fontSizeWidth: 4.sp,
                                    fontWeight: FontWeight.bold,
                                    fontFamily: AppTextStyles.Almarai,
                                                                                ...
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                                    Container(
                                                                                      ...
                                                                                      width: 50.w,
                                                                                      child: TextCustom(theText: snapshot.data['data'][i]['services_main_id'].toString(), fontSizeWidth: 5.2.sp, fontFamily: AppTextStyles.Almarai, fontColor: AppColors.balckColorTypeThree, height: 1.5.h),
                                                                                    ),
                                                                                    SizedBox(
                                                                                      width: 5.w,
                                                                                    ),
                                                                                    ...
                                                                                    Container(
                                                                                      alignment: Alignment.center,
                                                                                      width: 50.w,
                                                                                      child: TextCustom(theText: snapshot.data['data'][i]['services_main_name_en'].toString(), fontSizeWidth: 5.2.sp, fontFamily: AppTextStyles.Almarai, fontColor: AppColors.balckColorTypeThree, height: 1.5.h),
                                                                                    ),
                                                                                    SizedBox(
                                                                                      width: 5.w,
                                                                                    ),
