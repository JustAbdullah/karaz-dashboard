                            ...
                            Align(
                              ...
                              child: PaddingCustom(
                                ...
                                child: TextCustom(
                                    height: 1.5,
                                    theText:
                                        "معلومات واحصائيات شاملة عن الملاحظات  المتوفرة في قاعدة البيانات",
                                    fontSizeWidth: 4.sp,
                                    fontWeight: FontWeight.bold,
                                    fontFamily: AppTextStyles.Almarai,
                                                                  ...
                                                                  child: Column(
                                                                    children: [
                                                                      Container(
                                                                        ...
                                                                        child: TextCustom(
                                                                            theText:
                                                                                snapshot.data['data'][i]['date_of_notice'].toString(),
                                                                            fontWeight: FontWeight.bold,
                                                                      ...
                                                                      TextCustom(
                                                                          theText: snapshot.data['data'][i]['notice_body']
                                                                              .toString(),
                                                                          fontSizeWidth: 5.2
                                                                              .sp,
                                                                      ...
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          TextCustom(
                                                                              theText: "الملاحظة مُضافة من طرف:",
                                                                              fontSizeWidth: 5.2.sp,
                                                                              fontFamily: AppTextStyles.Almarai,
                                                                              fontColor: AppColors.balckColorTypeThree,
                                                                              height: 1.5.h),
                                                                          TextCustom(
                                                                              theText: snapshot.data['data'][i]['admin_name'].toString(),
                                                                              fontSizeWidth: 5.2.sp,
                                                                              fontFamily: AppTextStyles.Almarai,
