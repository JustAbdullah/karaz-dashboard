                                                    ...
                                                    builder:
                                                        (BuildContext context,
                                                            AsyncSnapshot
                                                                snapshot) {
                                                      if (snapshot.hasData) {
                                                        return controller.noDataSearching.value ==
                                                                            false
                                                                        ? Center(
                                                                            child:
                                                                                Column(
                                                                              ...
                                                                              children: [
                                                                                TextCustom(height: 1.3.h, theText: "لايوجد هنالك بيانات من عملية البحث", fontSizeWidth: 15, fontFamily: AppTextStyles.Almarai, fontWeight: FontWeight.bold, fontColor: AppColors.theAppColorBlue),
                                                                              ],
                                                                            ),
                                                                          )
                                                                        : 
